...
flags.DEFINE_string('output_path', None,
                    'Path to the output the results in a csv.')
...
def display(confusion_matrix, categories, output_path):
    ...
    for i in range(len(categories)):
        ...
        results.append({'category': name, 'precision_@{}IOU'.format(IOU_THRESHOLD): precision, 'recall_@{}IOU'.format(
            IOU_THRESHOLD): recall, 'map_@{}IOU'.format(IOU_THRESHOLD): avg_prec, 'f1_@{}IOU'.format(IOU_THRESHOLD): f1})
