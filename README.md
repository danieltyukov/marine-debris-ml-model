...
Using this [script](https://github.com/danieltyukov/marine-debris-ml-model/tree/main/object_detection_api/export_inference_graph.py), create the marine debris detection model inference graph with:
